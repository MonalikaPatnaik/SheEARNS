...
const Navbar = () => {
  ...
  return (
    <div>
      <div className='nav-flexbox'>
        <Link to="./"><p className='nav-logo'>SheEarns</p></Link>
        <div className='nav-mid'>
        <NavLink to='/'><p className='nav-mid-cont'>Home</p></NavLink>
  ...
  <div class="form-outline" data-mdb-input-init>
    <input type="search" id="form1" class="form-control nav-search-input" placeholder="Explore !" onChange={(e)=>setKeyword(e.target.value)}/>
    
  </div>
  <button type="button" style={{"backgroundColor":"#c15feb", "color":"white"}} class="btn" data-mdb-ripple-init>
...
{isAuthenticated? (<div>
           ...
           <Link to="/wishlist"><p className='nav-mid-cont'><img src={heart} width={30}/></p></Link> 
